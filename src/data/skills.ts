...
export const SKILLS: Skill[] = [
  ...
  {
    id: 35,
    name: 'Neo4j / Graph Databases (Cypher, GDS)',
    category: 'Databases',
    appearsIn: [],
    learnOrder: 4,
    rating: 4,
    phase: 'Phase 4 – Differentiators',
    notes: 'First-class graph DB skills for GraphRAG, fraud, knowledge graphs, recsys.',
  },
  {
    id: 36,
    name: 'Knowledge Graphs for AI (Entities, Ontologies)',
    category: 'AI / GenAI',
    appearsIn: [],
    learnOrder: 5,
    rating: 4,
    phase: 'Phase 5 – Future-Ready (2026+)',
    notes: 'Structured memory for agents; pairs with GraphRAG and reasoning.',
  },
  {
    id: 37,
    name: 'Claude Engineering (Computer Use, Sub-agents, Skills)',
    category: 'AI / GenAI',
    appearsIn: [],
    learnOrder: 5,
    rating: 5,
    phase: 'Phase 5 – Future-Ready (2026+)',
    notes: 'Anthropic-specific APIs are now their own discipline (Skills, Sub-agents, Artifacts).',
  },
  {
    id: 38,
    name: 'Agent Memory Stores (Mem0, Zep, Letta, LangMem)',
    category: 'AI / GenAI',
    appearsIn: [],
    learnOrder: 5,
    rating: 5,
    phase: 'Phase 5 – Future-Ready (2026+)',
    notes: 'Long-term agent memory is the next RAG; dedicated tooling exists now.',
  },
  {
    id: 39,
    ...
    rating: 5,
    phase: 'Phase 5 – Future-Ready (2026+)',
    notes: 'Claude Computer Use, OpenAI Operator, Playwright agents — reshaping RPA.',
  },
  {
    id: 40,
    name: 'Time-series & Analytics DBs (TimescaleDB, ClickHouse, DuckDB)',
    category: 'Databases',
    appearsIn: [],
    learnOrder: 4,
    rating: 3,
    phase: 'Phase 4 – Differentiators',
    notes: 'Analytics behind AI products; common in observability and feature stores.',
  },
];
